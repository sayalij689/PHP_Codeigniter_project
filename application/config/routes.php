...
$route['admin/employees/create'] = 'admin/employees/create';
$route['admin/employees/store'] = 'admin/employees/store';
$route['admin/employees/edit/(:num)'] = 'admin/employees/edit/$1';
$route['admin/employees/update/(:num)'] = 'admin/employees/update/$1';
